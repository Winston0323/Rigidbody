...
Pit::Pit(GLfloat size, glm::vec3 origin, GLfloat pitSize)
{
	...
	std::vector<std::pair<glm::vec3, glm::vec3>> tempEdge = leftHorz->getEdges();
	edges.insert(edges.end(), tempEdge.begin(), tempEdge.end());
